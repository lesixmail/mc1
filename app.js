...
const BIN_FIELD_DOC = {
  adv: {
    ...
    commissionRate: "挂单手续费率", takerCommissionRate: "taker手续费率", minTakerFee: "最低taker费",
    tradeMethodCommissionRates: "各支付方式费率", fiatSymbol: "法币符号", assetScale: "资产精度",
    fiatScale: "法币精度", priceScale: "价格精度", launchCountry: "投放国家", abnormalStatusList: "异常状态",
    createTime: "创建时间", advUpdateTime: "更新时间", inventoryType: "库存类型", isSafePayment: "安全支付",
    allowTradeMerchant: "允许商家交易", storeInformation: "店铺信息", voucherTemplate: "优惠券",
    userTradeCompleteRateMin: "买家最低成单率要求", userTradeCountFilterTime: "买家成交统计周期",
    userTradeVolumeMin: "买家最低成交额要求", userBuyTradeCountMin: "买家最低买单数要求",
    userAllTradeCountMin: "买家最低总单数要求", dynamicMaxSingleTransQuantity: "动态单笔最大数量",
    amountAfterEditing: "改后金额", nonTradableRegions: "禁交易地区", privilegeType: "特权类型",
  },
  advertiser: {
    ...
    tagIconUrls: "标签图标", email: "邮箱(认证标志)", mobile: "手机(认证标志)",
    advConfirmTime: "广告确认时长", merchantGroupMember: "商家组成员",
  },
  tradeMethods: {
